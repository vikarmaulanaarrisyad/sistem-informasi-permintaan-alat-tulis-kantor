                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-9 col-lg-8 mx-auto">
                                ...
                                <h2 class="login-heading mb-4"><b>SI<strong class="text-danger">TATIK</strong></b></h2>
                                <h4 class="login-heading">Sistem Informasi Permintaan Alat Tulis Kampus</h4>
                                ...
                                <form action="{{ route('login') }}" method="post">
                                    ...
                                    <div class="text-center mt-3">
                                        <div class="text-muted">
                                            Copyright © 2023 | Politeknik Harapan Bersama Logistik
                                        </div>
                                    </div>
                                </form>
                            </div>
