    ...
    <x-card>
        <div class="row justify-content-center">
            <div class="col-lg-4">
                ...
                <div class="text-center">
                    <img src="{{ Storage::url($setting->path_image) }}" alt="" class="img-thumbnail preview-path_image" width="200">
                </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="text-center">
                    <img src="{{ Storage::url($setting->path_image_header) }}" alt="" class="img-thumbnail preview-path_image_header" width="200">
                </div>
                <div class="form-group mt-3">
                    <div class="custom-file">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-4">
                ...
                <div class="text-center">
                    <img src="{{ Storage::url($setting->path_image_footer) }}" alt="" class="img-thumbnail preview-path_image_footer" width="200">
                </div>
                <div class="form-group mt-3">
                    <div class="custom-file">
